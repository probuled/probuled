...
export function SocialFollow() {
  return (
    <section
      className="py-[clamp(4rem,8vw,8rem)] bg-white border-t border-[#E4E1D6]"
      id="community"
    >
      <div className="w-full max-w-container mx-auto px-[clamp(1.25rem,4vw,4rem)]">
        <SectionHeader
          eyebrow={
            <>
              <Icon name="users" size={14} /> Comunidade
            </>
          }
          title="Acompanhe a ProBuled"
          sub="Conteúdo sobre produto, engenharia e bastidores do estúdio. Nos acompanhe nas redes sociais."
        />
              ...
              <div className="reveal" data-delay={String(i + 1)} key={label}>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      style={
                        { color: theme.borderColor } as React.CSSProperties
                      }
                  ...
                  <div className="flex flex-col gap-1 flex-1">
                    ...
                    <span className="text-[0.875rem] text-[#807D72] font-mono">
                      {handle}
                    </span>
                    <p className="text-[0.9375rem] text-[#424039] leading-[1.55] mt-2">
                      {description}
                    </p>
                  </div>
