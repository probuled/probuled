...
export function Icon({ name, size = 24, stroke = 2, color = 'currentColor', className, ...rest }: IconProps) {
  ...
  return (
    <svg
      className={`inline-block align-middle flex-none${className ? ' ' + className : ''}`}
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
